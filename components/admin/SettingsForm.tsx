    ...
    <form className={docStyles.composer} onSubmit={save}>
      ...
      <section className={`${admin.panel} ${admin.panelPad}`}>
        <div className={docStyles.grid2}>
          ...
          <label className={admin.field}><span className={admin.label}>Default invoice due days</span><input className={admin.input} type="number" min="0" max="365" value={settings.defaultInvoiceDueDays} onChange={(event) => field("defaultInvoiceDueDays", Number(event.target.value))} /></label>
